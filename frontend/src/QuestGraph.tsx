...
export default function QuestGraph({ projectId, projectPath }: QuestGraphProps) {
  ...
  const edit = {
    ...
    repeatCooldown: ui.editState.repeatCooldown[0], setRepeatCooldown: ui.editState.repeatCooldown[1],
    ...
    hideLockIcon: ui.editState.hideLockIcon[0], setHideLockIcon: ui.editState.hideLockIcon[1],
    guidePage: ui.editState.guidePage[0], setGuidePage: ui.editState.guidePage[1],
    maxCompletableDependents: ui.editState.maxCompletableDependents[0], setMaxCompletableDependents: ui.editState.maxCompletableDependents[1],
