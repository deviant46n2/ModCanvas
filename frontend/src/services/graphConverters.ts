...
export function graphToApiData(
  ...
  return {
    ...
    nodes: nodes.map((n) => ({
      ...
      repeat_cooldown: (n.data?.repeat_cooldown as number) || 0,
      ...
      hide_lock_icon: (n.data?.hide_lock_icon as boolean) || false,
      guide_page: (n.data?.guide_page as string) || '',
      max_completable_dependents: (n.data?.max_completable_dependents as number) || 0,
