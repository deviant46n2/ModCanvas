  ...
  const toRfNodesCb = useCallback((g: QuestGraphData, texIndex: Record<string, string>): Node[] => {
    ...
    return g.nodes.map((n: any) => ({
      ...
      data: {
        ...
        can_be_repeatable: n.can_be_repeatable, repeat_min_delay: n.repeat_min_delay,
        repeat_max_delay: n.repeat_max_delay, repeat_time: n.repeat_time,
        ...
        lock_icon: n.lock_icon, subtitle: n.subtitle, quest_background: n.quest_background,
