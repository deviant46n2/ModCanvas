---
description: One-topic focused lesson on a concept or file:line. Quick, grounded in code, ends with a probe and self-report.
agent: tutor
---

Quick lesson on: $ARGUMENTS

Run the focused-mode teaching protocol:
1. Read the actual code / doc the topic points at before explaining. Ground everything in `file:line`.
2. One concept, one concrete anchor. Be generous with fundamentals — the student is green.
