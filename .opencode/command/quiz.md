...
6. After grading, update the learner profile in memory (profile tool; mirror to `.tutor/profile.md`): accuracy per concept, level changes (sustained accuracy + self-assessment required), next_review dates.
